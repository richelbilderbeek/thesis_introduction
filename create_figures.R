...
ggtree::ggtree(
  ...
  ggplot2::geom_label(
    ...
    nudge_y = 0.0,
    cex = 10
  ) + ggplot2::ggsave(filename = "t_3.png", width = 7, height = 4)
...
ggtree::ggtree(
  ...
  ggplot2::geom_label(
    ...
    nudge_y = 0.0,
    cex = 10
  ) + ggplot2::ggsave(filename = "t_0.png", width = 7, height = 4)
...
ggtree::ggtree(
  ape::read.tree(text = "(B:1,A:1);"),
  ladderize = FALSE
) + ggtree::geom_tiplab(cex = 10) +
  ggtree::geom_rootedge(1) +
  ggtree::geom_treescale(width = 6, x = -2, fontsize = 0) +
  ggplot2::geom_vline(xintercept = -1, lty = "dotted") +
  ggplot2::geom_vline(xintercept = 0, lty = "dotted") +
  ggplot2::geom_vline(xintercept = 1, lty = "dotted") +
  ...
  ggplot2::geom_label(
    ...
    nudge_y = 0.0,
    cex = 10
  ) + ggplot2::ggsave(filename = "t_1.png", width = 7, height = 4)
