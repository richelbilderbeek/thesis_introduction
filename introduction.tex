...
Felsenstein's work in 1980, creating (and still maintaining!) PHYLIP, 
...
\rampal{Provide references to Felsenstein's paper and to the software packages}
...
\rampal{what do you mean by amino acid positions? Don't you mean protein sequences? Furthermore, you haven't explained what a protein sequence is. Given that you discuss things at a low level, I think this should be added.}
...
\rampal{You introduce the word transition, but you haven't explained you mean by this.}
...
esd provided by Revell and colleagues (\cite{revell2005under}).
They simulated many phylogenies and corresponding DNA sequences 
...
\rampal{This is a nice example but you introduce the words substitution model, alignment and DNA sequences without further explanation.}
...
\rampal{What is this last standard clock model called? And what is the difference between the two relaxed clock models?} 
