...
however, is a complex topic. There are many ways, like bootstrapping, 
jack-knifing, parsimony, maximum likelihood, UPGMA and more.

\begin{figure}[H]
  \includegraphics[width=0.4\textwidth]{phylogeny_40_upgma.png}
  \caption{
    Phylogeny created using UPGMA
  }
  \label{fig:phylogeny_upgma}
\end{figure}

The precise methodology to do so, is, however, more complex. There
are even multiple ways to a

, to get from a DNA sequence alignment, to a
dated overview of evolutionary relationships, however, is complex.
